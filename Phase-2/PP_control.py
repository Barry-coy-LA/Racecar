...
class PurePursuit_Controller:
    ...
    def _get_current_waypoint(self, waypoints, lookahead_distance, position, theta):
        ...
        if nearest_dist < lookahead_distance:
            ...
            return np.append(wpts[i, :], waypoints[i, self.conf.wpt_vind]), nearest_point, nearest_dist
        else:
            return None
    ...
    def controller(self, pose_x, pose_y, pose_theta, lookahead_distance, vgain):
        ...
        speed = vgain * speed
        # error_term, steering_angle = self.PD(step_reward, speed, steer, error_term, lookahead_point, position)
